...
# source: goten/contrib/protobuf/validate.proto
...
FieldRules = _reflection.GeneratedProtocolMessageType('FieldRules', (_message.Message,), dict(
  ...
  __module__ = 'goten.contrib.protobuf.validate_pb2'
