...
func fieldCoder(fd pref.FieldDescriptor, ft reflect.Type) (*MessageInfo, pointerCoderFuncs) {
	...
	case fd.Cardinality() == pref.Repeated && !fd.IsPacked():
		...
		case pref.StringKind:
			...
			if ft.Implements(reflect.TypeOf((*pref.ProtoStringer)(nil)).Elem()) {
	...
	case fd.Kind() == pref.StringKind && ft.Kind() == reflect.Ptr && ft.Implements(reflect.TypeOf((*pref.ProtoStringer)(nil)).Elem()):
